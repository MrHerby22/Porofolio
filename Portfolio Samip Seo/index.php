...
$conn = new mysqli('localhost', 'root', '', 'blog_db'); // Replace with your database details
...
<html lang="en" dir="ltr">
 ...
 I'm Selecting Directly 'Section Tag' and 'Class'  */
      ...
      body { font-family: Arial, sans-serif; }
        ...
        .post-title { font-size: 24px; font-weight: bold; margin-top: 15px; }
        .post-content { margin-top: 10px; }
        .post-date { color: #777; font-size: 12px; margin-top: 5px; }
        .read-more { display: inline-block; margin-top: 10px; text-decoration: none; color: #007BFF; }
    </style>
  ...
  <body>
    ...
    <div class="container">
        ...
        <div class="post-card">
            ...
            <div class="post-content"><?php echo substr(htmlspecialchars($row['content']), 0, 150); ?>...</div>
            <div class="post-date">Posted on <?php echo date('F j, Y', strtotime($row['created_at'])); ?></div>
            <a class="read-more" href="post.php?id=<?php echo $row['id']; ?>">Read More</a>
        </div>
        <?php endwhile; ?>
    </div>
